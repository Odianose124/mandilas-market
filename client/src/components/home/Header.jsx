...
function Header() {
  ...
  /*
   * Determine whether the logged-in user is a seller.
   */
  const isSeller =
  ...
  /*
   * Get the correct dashboard for the user.
   */
            ...
            {user ? (
              ...
              >
                ...
                {showAccountMenu && (
                  ...
                  <div className="absolute right-0 top-full mt-3 w-72 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-[100]">
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-3 text-left px-5 py-4 text-red-600 hover:bg-red-50 transition border-t"
                    >
                      <LogOut size={19} />
